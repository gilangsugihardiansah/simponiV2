...
/**
 * PlnEVpController implements the CRUD actions for PlnEVp model.
 */
class PlnEVpController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all PlnEVp models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new PlnEVpSearch();
    ...
    /**
     * Finds the PlnEVp model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return PlnEVp the loaded model
