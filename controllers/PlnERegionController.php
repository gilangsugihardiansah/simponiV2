...
use app\models\PlnERegionSearch;
...
/**
 * PlnERegionController implements the CRUD actions for PlnERegion model.
 */
class PlnERegionController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all PlnERegion models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new PlnERegionSearch();
    ...
    /**
     * Finds the PlnERegion model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return PlnERegion the loaded model
